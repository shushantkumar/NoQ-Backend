...
router.get('/:day/:month/n/:name/:sid',cors(method),(req,res,next)=>{

    Court.find({day: req.params.day ,month: req.params.month,courtName : req.params.name , usersDetails : req.params.sid})
    .select()  
    .exec()
    .then(docs => {
        console.log(docs);
